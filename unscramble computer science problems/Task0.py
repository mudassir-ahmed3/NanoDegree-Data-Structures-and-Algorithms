...
"""
#print(texts) list of lists
# print(texts[0][0]
print("First Record of texts, "+texts[0][0]+" texts "+texts[0][1]+" at time "+texts[0][2])
# LRI = len(calls)-1 #LRI=> Last Record Index
#print(LRI)
#print(calls)
# print("last record of calls, "+calls[LRI][0]+" calls "+calls[LRI][1]+" at time "+calls[LRI][2]+", lasting "+calls[LRI][3]+" seconds")
